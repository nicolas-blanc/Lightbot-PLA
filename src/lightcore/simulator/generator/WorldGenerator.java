...
public abstract class WorldGenerator {
	 ...
	 * 
	 * @param maxLight
	 *            The maximum number of the light in this world
	 * @param numLight
	 *            The current number of the light in the algorithm
	 * @return Return an action among the possible action of the robot, -1 if
	 *         there is an error
	 */
	 ...
	 * 
	 * @param cell
	 *            The current cell that was already
	 * @param action
	 *            The instruction for create the next cell
	...
	/**
	 * Get a random case in the grid for the first case of the algorithm and
	 * generate then.
	 * 
	...
	/**
	 * Generate all cell to create a rectangular in function of the generated
	 * world
	 */
	...
	/**
	 * Represent where there are cell in the grid, the number is the maximum
